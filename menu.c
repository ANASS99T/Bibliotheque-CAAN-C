...
void menu()
{
	...
	switch (choix)
	{
		...
		case 6:
			...
			{
				do{
					printf("\nPour afficher les livres entrer \"1\" et pour afficher les exemplaire entrer \"2\" : ");
					scanf("%d", &choix3);
		...
		case 7:
			...
			{
				do{
					printf("\nPour ajouter un livre entrer \"1\" et pour afficher les exemplaire entrer \"2\" : ");
					scanf("%d", &choix3);
				}while(choix3 != 1 && choix3 != 2);
				if(choix3 == 1){				
		...
		case 10:
			...
			else if(choix1 == 1)
			{
				...
				{
					printf("\nPour supprimer un exemplaire inserer son ID:");
					scanf("%d", &id);
					deleteExemplaire(id);
					do{
					printf("\n1) Retour au menu | 0) Arreter le programme ");
		...
		case 14 :
			...
			else
			{
				...
				printf("	|			    |			    		 |                          |\n");
				printf("	|                           |  8) Modifier une Categories        |  13) Supprimer une Offre |\n");
				printf("	|			    |			    		 |                          |\n");
				printf("	|  4) Supprimer un Auteur   |  9) Supprimer une Categories      |                          |\n");
				printf("	|			    |			    		 |                          |\n");
				...
				do{
					printf("\nVeuillez choisir le numero de la fonction que vous souhaitez (Inserer \"0\" pour arreter) : ");
					scanf("%d", &choix4);
				}while(choix != 0 &&choix != 1 && choix != 2 && choix != 3 && choix != 4 && choix != 5 && choix != 6 && choix != 7 && choix != 8 && choix != 9 && choix != 10 && choix != 11 && choix != 12 && choix != 13);
